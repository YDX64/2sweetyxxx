                  ...
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary"><?php echo $lang['Interest']; ?><i class="fa fa-circle"> </i></p>
			  ...
			  <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary"><?php echo $lang['Language']; ?><i class="fa fa-circle"> </i></p>
			  ...
			  <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary"><?php echo $lang['Religion']; ?><i class="fa fa-circle"> </i></p>
			  ...
			  <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary"><?php echo $lang['Relation_Goal']; ?><i class="fa fa-circle"> </i></p>
			  ...
			  <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary"><?php echo $lang['Plan']; ?><i class="fa fa-circle"> </i></p>
			   ...
			   <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary"><?php echo $lang['Total_Pages']; ?><i class="fa fa-circle"> </i></p>
			  ...
			  <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary">Total Gift<i class="fa fa-circle"> </i></p>
                        <h4><?php echo $dating->query("select * from tbl_gift")->num_rows;?></h4>
                      </div>
                      <div class="d-flex static-widget">
                        <img src="images/dashboard/eight.svg" style="width: 60px;">
			  ...
			  <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary">Total Package<i class="fa fa-circle"> </i></p>
                        <h4><?php echo $dating->query("select * from tbl_package")->num_rows;?></h4>
                      </div>
                      <div class="d-flex static-widget">
                        <img src="images/dashboard/eight.svg" style="width: 60px;">
			  ...
			  <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary">Total Male<i class="fa fa-circle"> </i></p>
                        <h4><?php echo $dating->query("select * from tbl_user where gender='MALE'")->num_rows;?></h4>
                      </div>
                      <div class="d-flex static-widget">
                        <img src="images/dashboard/eight.svg" style="width: 60px;">
			  ...
			  <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary">Total Female<i class="fa fa-circle"> </i></p>
                        <h4><?php echo $dating->query("select * from tbl_user where gender='FEMALE'")->num_rows;?></h4>
                      </div>
                      <div class="d-flex static-widget">
                        <img src="images/dashboard/eight.svg" style="width: 60px;">
			  ...
			  <div class="col-sm-6 col-lg-3">
                <div class="card o-hidden">
                  <div class="card-header pb-0">
                    <div class="d-flex"> 
                      <div class="flex-grow-1"> 
                        <p class="square-after f-w-600 header-text-primary">Total Fake User<i class="fa fa-circle"> </i></p>
                        <h4><?php echo $dating->query("select * from tbl_user where user_type='FAKE_USER'")->num_rows;?></h4>
                      </div>
                      <div class="d-flex static-widget">
                        <img src="images/dashboard/eight.svg" style="width: 60px;">
